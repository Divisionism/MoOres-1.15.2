...
public class AlloyScreen extends ContainerScreen<alloyContainer> {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        this.font.drawString(this.title.getFormattedText(), 8.0f, 6.8f, 4210752);
        this.font.drawString(this.playerInventory.getDisplayName().getFormattedText(), 8.0f, 55.0f, 4210752);
    }
